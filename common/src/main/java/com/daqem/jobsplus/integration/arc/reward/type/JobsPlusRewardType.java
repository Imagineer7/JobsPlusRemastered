...
import com.daqem.jobsplus.integration.arc.reward.rewards.job.JobActionCoinReward;
...
public interface JobsPlusRewardType<T extends IReward> extends RewardType<T> {
    ...
    IRewardType<JobActionCoinReward> JOB_ACTION_COIN = RewardType.register(JobsPlus.getId("job_action_coin"), new JobActionCoinReward.Serializer());
